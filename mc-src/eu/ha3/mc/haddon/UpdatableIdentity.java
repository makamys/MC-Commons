...
public interface UpdatableIdentity extends Identity {
    ...
    /***
     * Returns the platform version this is made for. In practice this is used by
     * the update notifer to check if the updates are made for this version of the
     * platform or another one.
     */
