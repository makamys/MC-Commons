...
public interface Utility {
    ...
    /**
     * Creates a virtual constructor for the given class. Returns a dummy if the
     ...
     * <p>
     * i.e There are no guis currently open that pause the game, we are not on a lan
     * server, nor on a dedicated server.
     */
     ...
     * Alignment is a number between 1 and 9. It corresponds to the key position of
     * a classic layout keyboard numpad. For instance, 7 means "top left", because
     * the key "7" is at the top left.
     *
